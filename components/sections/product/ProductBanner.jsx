      ...
      {dataJSON && (  
        <section className = "relative px-4 py-10 mx-auto max-w-7xl">
          <div className = "relative flex flex-col justify-center w-full p-6 overflow-hidden rounded-md aspect-[16/9] md:aspect-[16/7] lg:aspect-[16/5] bg-neutral-300">
            <div className = "absolute inset-0 z-10 opacity-80 boxShadow"/>
            <Image src = {dataJSON.image} layout = 'fill' objectFit='cover' objectPosition={dataJSON.imagePos} className = "pointer-events-none select-none z-[1]" priority/>
