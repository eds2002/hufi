          ...
          <div aria-labelledby="features-heading" className="relative h-[40vh] md:h-[60vh] w-full`">
            <div className="absolute inset-0 w-full">
              ...
              <div className = "absolute inset-0 flex items-center justify-start px-4 mx-auto max-w-7xl">
                <div
                  className="max-w-sm prose-h1:text-primaryVariant prose-h1:text-2xl prose-p:text-primary/80 prose-p:mt-2 prose-p:lg:text-lg prose-p:sm:text-base prose-p:text-sm prose-p:font-light"
        ...
        {data?.product?.imageThree?.reference?.image?.url ? 
          <div aria-labelledby="features-heading" className="relative h-[40vh] md:h-[60vh] w-full`">
            <div className="absolute inset-0 w-full">
              ...
              <div className = "absolute inset-0 flex items-center justify-start px-4 mx-auto max-w-7xl">
                <div
                  className="max-w-sm prose-h1:text-primaryVariant prose-h1:font-medium prose-h1:text-2xl prose-p:text-primary prose-p:mt-2 prose-p:lg:text-lg prose-p:sm:text-base prose-p:text-sm prose-p:font-light"
