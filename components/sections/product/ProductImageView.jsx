        ...
        <div className = "flex flex-col w-full h-full md:flex-row">
          ...
          <div className = "flex items-center justify-center md:justify-start py-14 md:flex-1">
            <div className = "max-w-sm px-4 ml-0 text-center md:ml-10 md:text-left">
              <div
                className="prose-h1:md:text-4xl prose-h1:text-xl prose-h1:font-medium prose-p:mt-4 prose-p:text-base prose-p:text-onBackground/70 prose-p:xl:text-lg"
        ...
        <div className = "flex flex-col md:flex-row">
          ...
          <div className = "flex items-center justify-center md:justify-start py-14 md:flex-1">
            <div className = "max-w-sm px-4 text-center md:ml-10 md:text-left">
              <div
                className="prose-h1:text-5xl prose-h1:font-medium prose-p:mt-4 prose-p:text-base prose-p:text-onBackground/70 prose-p:xl:text-lg"
