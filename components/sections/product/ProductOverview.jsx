          ...
          <div className="lg:grid lg:auto-rows-min lg:grid-cols-12 lg:gap-x-8">
            <div className="lg:col-span-5 lg:col-start-8">
              <div className="flex justify-between">
                <h1 className="text-xl font-medium text-primary2">{product.name}</h1>
                <p className="text-xl font-medium text-primary2">{product.price}</p>
              </div>
              {/* Reviews */}
              <div className="mt-4">
                ...
                <div className="flex items-center">
                    ...
                    {[0, 1, 2, 3, 4].map((rating) => (
                      <StarIcon
                        ...
                        className={classNames(
                          product.rating > rating ? 'text-secondary1' : 'text-gray-200',
                  ...
                  <div className="ml-4 flex">
                    <a href="#" className="text-sm font-medium text-secondary2 hover:text-secondary2/50 transition">
