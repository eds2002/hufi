      ...
      <div className = "relative w-full h-full">
        ...
        <div className = "absolute inset-0 flex items-center justify-center rounded-md bg-black/40">
          <div className = "flex flex-col items-center justify-center w-full max-w-md">
            ...
            <h1 className = "text-2xl text-background">We love our pets.</h1>
            <p className = "text-center text-background/80">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eaque, deserunt reiciendis. Velit sunt dolorem debitis eligendi cum dolorum, illum eum modi ea minus voluptate magni similique alias corrupti dolore nostrum!</p>
