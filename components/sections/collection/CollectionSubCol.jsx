          ...
          <React.Fragment key = {index}>
            <div className = "py-6">
              {collectionSet?.heading?.title != "" && (
                <h3 className = "px-4 mx-auto mb-3 text-xl font-medium md:text-2xl max-w-7xl">{collectionSet?.heading?.title ?? 'Collection Heading'}</h3>
              )}
              <div className = {`
                ...
                ${collectionSet.style.type === "TwoRow" && (`grid md:grid-cols-2  w-full h-[70vh] gap-3 max-w-7xl px-4 mx-auto pb-10`)}
                ${collectionSet.style.type === "Banner" && (`grid h-[40vh] gap-3 max-w-7xl px-4 mx-auto pb-10`)}
...
function CollectionBox({set,index,collectionSet}){
  ...
  return(
    <div className = {`
      ...
      <div className={`
        ${collectionSet.style.type === "Squared" && ('p-4 relative flex items-center justify-center bg-primaryVariant2/5 w-full h-full mx-auto max-w-7xl aspect-square')}
      ...
      `}>
        ...
        <div 
          ...
          ${collectionSet.style.type === "Squared" && ('prose-h6:text-xl prose-h6:font-medium prose-h6:text-primary prose-h6:text-opacity-90 prose-h3:hidden prose-a:hidden w-min text-center prose-h6::cursor-pointer cursor-pointer')}
