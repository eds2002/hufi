                ...
                <Dialog.Panel className="relative w-full max-w-md p-6 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                  ...
                  <div className="mt-4">
                    <p className="text-base text-gray-500">
                      Unknown shipping times are annoying. We love to provide an estimate on shipping times according to our suppliers. This date is our estimate onto when your package may arrive. Usually packages take around 7-10 business days to ship. 
                    </p>
                  </div>
