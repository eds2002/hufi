...
const Index = ({pageProps}) => {
  return (
    <>
      ...
      <Layout {...pageProps}>
        <section className = "w-full h-[90vh] py-24">
          <div className = "flex flex-col items-center justify-center w-full h-full px-4 pb-24 mx-auto max-w-7xl">
            <h1 className = "text-3xl font-medium text-center">We&apos;ll get back to you as soon as we can.</h1>
            ...
            <form onSubmit={(e)=>e.preventDefault()} className = "flex items-center justify-center w-full mt-10">
              <input className = "w-full max-w-md px-4 py-2 border border-black rounded-tl-full rounded-bl-full focus:outline-none focus:border-black/60"  required name = "textBox"/>
              <div className = "flex items-center justify-center h-full px-4 transition rounded-tr-full rounded-br-full cursor-pointer bg-secondaryVariant hover:bg-secondary hover:shadow-sm">
